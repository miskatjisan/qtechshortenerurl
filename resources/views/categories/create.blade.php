...
<body>
    ...
    <div class="col-9">
    <h4 class="bg-primary p-3 text-center text-light">Add New Category</h4>
      <form action="{{ route('categories.store') }}" method="post" >
        @csrf
        
        <label for="name">Category Name</label>

        <input type="text" class="form-control mt-3" name="name" id="name" placeholder="Enter Category Name" required>
